...
**Request Processing**
Redemption requests are handled on a first-come, first-served basis. We aim to process most redemptions within 1 business day, although it may take up to 7 days.

**Request Submission Gating**
Please note that we stop accepting redemption requests once daily submissions (from 00:00 to 00:00 UTC on the next day) reach the daily redemption limit.
...
![Withdrawal](../../../images/withdrawal.gif)
