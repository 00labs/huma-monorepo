...
Huma Institutional is a permissioned protocol designed for institutional investors to access curated credit opportunities. It enables participation in pools that provide receivables-backed credit lines, invoice factoring, and revolving credit facilities to payment financial institutions across the globe.The list below highlights the key building blocks of the protocol:
